/**
 * ANZAR Logo — SVG fidèle au design officiel
...
interface AnzarLogoProps {
  size?: number;
  className?: string;
  /** Render just the icon without the rounded square background */
  iconOnly?: boolean;
}
...
export default function AnzarLogo({ size = 32, className = '', iconOnly = false }: AnzarLogoProps) {
  if (iconOnly) {
    return (
      ...
      >
        {/* Letter A */}
        <path
          d="M50 10L18 85H30L38 65H62L70 85H82L50 10Z"
          fill="white"
        />
        <path
          d="M42 55L50 33L58 55H42Z"
          fill="#1a1a3e"
        />
        {/* Indigo bar */}
  ...
  return (
    ...
    >
      ...
      {/* Letter A */}
      <path
        d="M60 22L28 95H40L48 75H72L80 95H92L60 22Z"
        fill="white"
        fillOpacity="0.95"
      />
      <path
        d="M52 65L60 43L68 65H52Z"
        fill="#141432"
      />

      {/* Indigo bar across the A */}
      <rect x="40" y="62" width="44" height="8" rx="4" fill="#6366f1" />

      {/* Purple glowing dot at end of bar */}
